...
const NavBar = () => {
  ...
  return (
    <>
      <nav className="relative flex items-center justify-between w-full sticky top-0 px-5 lg:px-8 xl:px-[8%] py-4 bg-white h-15 z-50">
        ...
        <ul
          ref={sideMenuRef}
          className="flex md:hidden flex-col gap-4 py-20 px-10 fixed -right-64 top-0 bg-teal-500 w-64 h-120 transition-all duration-400 ease-in-out z-50"
        >
          <div className="absolute right-6 top-6" onClick={closeMenu}>
            <Icon.XIcon className="text-2xl cursor-pointer" weight="bold" />
          </div>
