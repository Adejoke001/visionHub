      ...
      <nav className={styles.navbar}>
        ...
        <ul className={styles.desktopNav}>
          ...
          <li className={styles.contactNavItem}>
            <Link href="/contact" className={styles.contactNavLink}>
        ...
        <div className={styles.desktopBookBtn}>
          <Link href="/booking" className={styles.bookButton}>
            <Icon.CalendarCheck weight="bold" size={20} className={styles.bookIcon} />
            <span>Book Now</span>
          </Link>
        </div>
        
        {/* Mobile Menu Button */}
        <button className={styles.menuButton} onClick={openMenu} aria-label="Open menu">
      ...
      <ul ref={sideMenuRef} className={styles.mobileMenu}>
        ...
        <li className={styles.mobileBookItem} onClick={closeMenu}>
          <Link href="/booking" className={styles.mobileBookButton}>
            <Icon.CalendarCheck weight="bold" size={20} className={styles.mobileBookIcon} />
            <span>Book Now</span>
          </Link>
        </li>
      </ul>
